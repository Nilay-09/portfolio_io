...
import Github from '../imgs/GalleryImgFolder/github.svg'
import Leetcode from '../imgs/GalleryImgFolder/leetcode.svg'
import Codechef from '../imgs/GalleryImgFolder/Muchhad.svg'
        ...
        <section className="w-full flex flex-col relative gap-[4rem]" id='contact'>
            ...
            <div className='relative w-full text-center mt-6 '>
                ...
                <div className='w-full flex justify-center flex-col md:flex-row mb-10'>
                    ...
                    <a href="mailto:nilayb07@gmail.com" className="text-[#6698FA] text-xl font-bold font-['Poppins'] hover:underline transition-all ease-in duration-100 ">
                        nilayb07@gmail.com
                    </a>
                </div>
                <motion.img
