...
import CardConvo from '../imgs/ProjectImgs/Convoclub.svg';
import Arrow from '../imgs/ProjectImgs/Redarrow.svg';

import CardArtist from '../imgs/ProjectImgs/Artist.svg';
import ArrowA from '../imgs/ProjectImgs/Yellowarrow.svg';
    ...
    return (
        <section className='flex justify-center items-center flex-wrap overflow-hidden relative mb-[6.25rem] w-screen px-[7.5rem]' id='projects'>
            ...
            <div className="grid grid-cols-1 project-align place-content-center  overflow-hidden gap-9 ">
                <a href="https://convoclub-io.vercel.app/" target="_blank" rel="noopener noreferrer">

                    <div className="flex justify-center relative cardHolder hoverEffect min-h-[18.75rem] box">
                ...
                <a href="https://artist-eight-lilac.vercel.app/" target="_blank" rel="noopener noreferrer" >
